            ...
            <div className="max-w-7xl w-full mx-auto flex items-center justify-between">
                ...
                <div className="bg-white flex gap-4 font-bold flex-col shadow-md rounded-md p-4">
                    <div>
                        ...
                        <p className="text-sm md:text-base">Player: <span id="playerScore">0</span></p>
                        <p className="text-sm md:text-base">Machine: <span id="machineScore">0</span> </p>
                    </div>
                    <button id="resetBtn" className="px-4 py-2 bg-sky-700 rounded-md text-white hover:bg-sky-900 transition duration-200">Reset</button>
                </div>
            </div>
        </header>
    )
