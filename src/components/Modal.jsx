export function Modal() {
    return (
        <div id="rulesModal" className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
            <div className="bg-white p-6 rounded-lg max-w-md w-full z-10">
                ...
                <button id="closeBtn" className="w-full px-4 py-2 bg-sky-600 hover:bg-sky-700 transition duration-200 text-white rounded-md">Close</button>
            </div>
        </div>
    )
}